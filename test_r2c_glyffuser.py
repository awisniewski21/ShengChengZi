...
def test_r2c_glyffuser(cfg: TrainConfig_R2C_Glyff):
...
@click.option("-r", "--run-name-prefix",      type=str, default="test_r2c_glyff",  help="Run name prefix for logging")
@click.option("-c", "--use-colab",            is_flag=True,                        help="Use Google Colab environment paths")
def main(*args, **kwargs):
    cfg = TrainConfig_R2C_Glyff(*args, **kwargs)
    return test_r2c_glyffuser(cfg)
