...
def test_c2c_cyclegan(cfg: TrainConfig_C2C_CycleGAN):
...
@click.option("-r", "--run-name-prefix",      type=str, default="test_c2c_cyclegan", help="Run name prefix for logging")
@click.option("-c", "--use-colab",            is_flag=True,                           help="Use Google Colab environment paths")
def main(*args, **kwargs):
    cfg = TrainConfig_C2C_CycleGAN(*args, **kwargs)
    return test_c2c_cyclegan(cfg)
