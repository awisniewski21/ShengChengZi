...
import torch
from diffusers import DDPMScheduler, UNet2DConditionModel  # NOQA
...
def train_t2c_glyffuser(cfg: TrainConfig_T2C_Glyff):
    print(f"Starting Text2Char training with Glyffuser model:")
...
def main(**kwargs):
    ...
    cfg = TrainConfig_T2C_Glyff(**filtered_kwargs)
    return train_t2c_glyffuser(cfg)
