#!/usr/bin/env python3
"""
Text-to-Character model training runner using the new base model architecture.
"""
...
def main():
    ...
    print(f"Starting Glyffuser T2C training with config:")
    print(f"  Image size: {cfg.image_size}")
    print(f"  Batch size: {cfg.train_batch_size}")
    print(f"  Epochs: {cfg.num_epochs}")
    print(f"  Learning rate: {cfg.learning_rate}")
    print(f"  Encoder dim: {cfg.encoder_dim}")
    ...
    # Model - conditional UNet for text-to-character
    ...
    training_model = TrainModel_T2C_Glyffuser(
        config=cfg,
